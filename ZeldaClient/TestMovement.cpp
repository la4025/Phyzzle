...
//	// auto& gamepad = GamePadManager::Instance(). 
//
//	/// 게임패드 관련
//	const int DEADZONE = Gampad.Getinstance().deadZone;
...
//
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_Q) == true)
//	{
//		const auto axis = trans->up;
//		trans->Rotate(axis, angle);
//	}
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_E) == true)
//	{
//		const auto axis = trans->up;
//		trans->Rotate(axis, -angle);
...
//	}
//
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_W) == true ||
//		thumbLY > 0)
//	{
//		movement += Eigen::Vector3f(0.0f, 0.0f, 0.1f);
//	}
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_S) == true ||
//		thumbLY < 0)
//	{
//		movement += Eigen::Vector3f(0.0f, 0.0f, -0.1f);
//	}
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_A) == true ||
//		thumbLX < 0)
//	{
//		movement += Eigen::Vector3f(-0.1f, 0.0f, 0.0f);
//	}
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_D) == true ||
//		thumbLX > 0)
//	{
//		movement += Eigen::Vector3f(0.1f, 0.0f, 0.0f);
//	}
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_SPACE) == true ||
//		)
//	{
//		movement += Eigen::Vector3f(0.0f, 0.1f, 0.0f);
//	}
//
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_N) == true)
//	{
...
//	}
//
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_Z) == true)
//	{
//		trans->SetLocalScale(trans->GetLocalScale().cwiseProduct(Eigen::Vector3f(1.1f, 1.1f, 1.1f)));
//	}
//
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_C) == true)
//	{
...
//
//	if (inputManager.IsKeyPressed(eKeyInput::eKEY_B) == true)
//	{
