...
ZeldaModel::ZeldaModel(const ZeldaModel& zeldaModel) :
	mVertexBuffer(zeldaModel.mVertexBuffer),
	mIndexBuffer(zeldaModel.mIndexBuffer),
	mVertexCount(zeldaModel.mVertexCount),
	mIndexCount(zeldaModel.mIndexCount)
{
...
bool ZeldaModel::Initialize(ID3D11Device* device)
{
	bool result;
